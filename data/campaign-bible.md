...
The following outcomes are **mandatory** for the campaign to function:
...
| **Maya's survival is optional** | Adv3 | If the heroes abandon Maya on the Indemnity, the campaign continues — but they lose their pilot, their moral compass, and one of the strongest emotional threads. The Banshee is at Bespin throughout Adv3 with Varth running the op from on board; Maya slips aboard the *The Indemnity* separately during the orbital chaos, not from Takodana. The Takodana rendezvous afterward is where the *Banshee* is flown back to Maz's castle, with the *Glorious Chariot* in tow as the prize. |
...
### Greed vs. Conscience
The campaign opens with a simple financial hook: get paid. Every adventure in Act 1 reinforces this motivation — there's always a bigger payday just out of reach. But each adventure also presents a moral choice that costs something: help a stranger, free slaves, rescue a Jedi. The tension between "what pays" and "what's right" is the engine of character development.

### Trust and Betrayal
Admiral Varth is the campaign's central relationship. He's charming, competent, and genuinely useful. He also lies about everything that matters. The betrayal in Adventure 6 is devastating precisely because Varth earned real trust through three acts of apparent partnership. Every NPC relationship in the campaign echoes this theme: Maya is loyal but was initially self-interested. Denia is genuine but is being manipulated. Varga is transparent in his villainy — and paradoxically more honest than Varth.

### Consequences of Action
The heroes' choices ripple forward. The insurrection they spark on Malpaz in Adventure 5 becomes the target of the Leviathan's demonstration strike in Adventure 10. The holocrons they retrieve in Adventure 4 become the navigation data Varth trades for command. Saving or abandoning Maya and Denia changes the resources available in Act 3. Nothing is disposable.
...
- Adv3 P2 S2: Players overhear Maya and Varth arguing about the slave ship — must-know narrative beat. Varth confirms in the open-channel exchange that the *Assiduous*'s EW package will jam the slave-circuit band the moment she gets in range, and names the only unjammable path: bridge override panel, hard-line, physically aboard the *Indemnity*. Maya understands the firmware path Varth has just handed her and goes silent. She slips aboard *The Indemnity* on her own (working her smuggler-network contacts on the dock crew to get aboard before it lifts), leaving the *Banshee* at Bespin with Varth. Varth knew and said nothing — he gave her the answer and did not give her a way back.
- Adv3 P3 S5: Breaks open comms during the orbital battle — "Hey — I could use a little more time here"
- Adv3 P3 S6: (If saved) Punches Varth at the rendezvous on Takodana. The crew flew the *Banshee* (and the captured *Glorious Chariot*) from Bespin to Maz's; Maya rode down on a freed-slave shuttle from the *Indemnity* once the orbital fight resolved.
...
**Backstory (GM Only):** Gilder Varth was born on Anaxes — the old Republic naval academy world. His family was mid-tier Core World aristocracy: comfortable, connected, and deeply invested in the idea that civilization required hierarchy. His father was a Republic naval logistics officer; his mother hosted political salons. Varth grew up believing that the galaxy was a machine and that competent people should run it. He wasn't wrong about the competent part. He was catastrophically wrong about who qualified.

He entered the Republic Naval Academy at sixteen. Brilliant student — top marks in strategic theory, logistics, and organizational psychology. Not a warrior. Never wanted to be. Varth understood systems: supply chains, information flows, personnel leverage. He graduated into the Republic Navy's logistics corps and spent the Clone Wars managing fleet supply operations from behind a desk on Coruscant. He never fired a shot in combat. He never had to. His weapon was always the spreadsheet, the requisition form, the well-timed memo.

When the Republic became the Empire, Varth didn't flinch. He didn't celebrate either. He simply observed that the machine had changed management and continued doing his job. He was promoted to Captain, then Rear Admiral, on the strength of his administrative competence. The Empire needed people who could move materiel without asking questions, and Varth was exceptional at not asking questions.

**The turn** came gradually. Varth was assigned to the logistics pipeline for Project Leviathan — a classified superweapon program operating out of Vel Shara in the Unknown Regions. He didn't know what Leviathan was at first. He just knew it consumed resources at an extraordinary rate and that the officers who ran it treated the supply chain like a personal fiefdom. The waste offended him. The incompetence offended him more. The officers above him were political appointees and ideologues — men who got their ranks through connections to Tarkin's circle, not through merit. Varth decided he deserved what they had.

He began skimming. Not impulsively — methodically. He used Varga the Hutt's existing supply chain infrastructure (the Empire was already contracting Besadii logistics for Outer Rim materiel) to create a parallel accounting layer. Credits flowing to Leviathan were diverted through Varga's network into an encrypted account that only Varth could access. He stole millions over eighteen months and hid the authentication key in the only vault he trusted — his own memory.

He was caught. Not through incompetence — through bad luck. A routine ISB audit flagged an anomaly that traced back to his requisition patterns. Varth was arrested, stripped of rank, and imprisoned at the Vanishing Place on Ajan Kloss — a black-site facility where the Empire stored people it wanted to forget.

But prison changed the equation. Varth had time to think. He studied the fragments of Leviathan data he'd seen and understood what the weapon actually was. He understood its potential. And he understood that the men building it were going to waste it — use it once for a demonstration, earn a promotion, and let it collect dust. Varth decided that if someone competent were in command — someone who understood logistics, leverage, and long-term strategy — the Leviathan could be a permanent instrument of power, not a one-shot political stunt.

He didn't want to destroy the Empire. He wanted to run it. Or at least the part of it that mattered.

Before his capture, Varth had arranged for a code cylinder — an Imperial ghost transfer authorization — to be smuggled out through intermediaries. It was a breadcrumb, a failsafe designed to eventually lead capable operators to his prison if the Empire ever decided to bury him. The cylinder bounced through the underworld for months before Maya intercepted it from Varga's supply chain on Jakku. The rest is the campaign.

**The Mask:** Varth's "Cool Uncle" persona is not an act — it's a *version* of himself. He genuinely likes the heroes. He genuinely enjoys their company. He finds Maya's conscience admirable in an abstract way. He respects the crew's competence. None of this stops him from using them. The tragedy of Varth is not that he's a sociopath pretending to care. It's that he *does* care — and he does it anyway. He's the man who scratches behind the dog's ears on the way to the pound. He compartmentalizes affection and utility so completely that he doesn't experience them as contradictory. This is what makes him more dangerous than a simple villain: he's not lying when he's charming. He's just also not lying when he's cold.

**The Nicknames:** Varth never uses the heroes' real names in the early adventures. He calls them "Kid," "Pilot," "Heavy," "Boss," "Ace," "Doc" — affectionate, distancing, and controlling. It establishes intimacy while denying personhood. When he finally uses a hero's real name — and he should, exactly once, in a moment of genuine vulnerability or anger — it should land like a slap. The GM should track this and deploy it deliberately.

**The Wafer's Other Use (GM Only):** Varth's interest in Arandis's 137.12 wafer is not what he tells the crew. Publicly it is a tactical asset — a slave-circuit boarding code for *The Indemnity* that Maya can use, or that the team can broadcast remotely to free the slaves during the orbital climax. Privately, the wafer is a piece of Imperial paymaster credentialing — a working sample of how Lt. Arandis's office talks to Besadii proxies in Hutt space. Varth wants it for **leverage in Act 2** — specifically, to spoof Imperial authorizations on the supply lanes the crew will be running through the Unknown Regions. He never mentions this. If the crew never recovers the wafer (Switch's Dirty Money fork), Varth is mildly inconvenienced and adapts; he does not push the issue. If they do recover it, he quietly pockets a copy at the Takodana rendezvous before pivoting to the Vel Shara pitch. **This is the Act-2 betrayal foreshadow** — the wafer is the first piece of Imperial infrastructure Varth steals on the heroes' dime.

**Relationship Map:**
- **Maya:** Respects her competence, recognizes her conscience as a liability. He knew she went to the Indemnity and said nothing. His betrayal of her is silence and omission — the most Varth thing possible. He doesn't pull the trigger himself. He just doesn't warn you about the cliff.
- **Denia:** An instrument. He recognized her value immediately and has been steering her knowledge since Adv2. If she's with the party, he's gentle with her — patient, respectful, almost tender. It's the patience of a locksmith with a delicate mechanism.
- **The Heroes:** Employees who don't know they're employees. He pays them (real money, real trust-building) and gives them genuine operational latitude because micromanaging competent people is inefficient. His respect for them is sincere. His willingness to sacrifice them is also sincere. These are not contradictions in his mind.
- **Draco:** A useful parallel track. Varth and Draco have no personal relationship — they are both tools of the same machine. Varth uses Draco's predictability (he will pursue Force-sensitives, he will enforce operational security) as a variable in his calculations. When Varth tips off Draco about Denia (alternate path), it's not malice — it's resource allocation.
- **Tarkin:** The man Varth needs to impress. Varth respects Tarkin's strategic vision but considers him wasteful. Tarkin sees Leviathan as a political tool; Varth sees it as a permanent fixture of Imperial power projection. Their alliance is transactional — Tarkin gets the navigation data, Varth gets the command chair.

**Arc:** Mysterious prisoner → Charming employer → Cold pragmatist → "The Man in the Chair" → Revealed manipulator → Leviathan commander → Campaign final boss
...
- Adv3 P2 S2: "The Pressure Cooker" — Players overhear Varth and Maya arguing about the Indemnity. "That is not why we are here." He shuts down the moral argument with operational logic — then, in the open-channel exchange, gives Maya the precise tactical truth: the *Assiduous*'s EW package will jam the slave-circuit band on close range, and the only unjammable path is the bridge override panel hard-line, physically aboard the *Indemnity*. He hands her the answer; he does not give her a way back. When Maya understands the firmware path and goes to the slave ship on her own, Varth notices. He says nothing. His betrayal is omission — operational truth delivered with no operational support.
...
**GM Guidance — How to Play Varth:**

*Voice:* Measured. Dry. Warm when he wants to be, which is often. He speaks in complete sentences and rarely raises his voice. When he's angry, he gets quieter. When he's lying, he sounds exactly the same as when he's telling the truth — because to him, the distinction is academic. He uses humor as a deflection tool and as genuine bonding. Both are real. Both serve a purpose.

*Physical presence:* Not physically imposing. Medium height, lean, carries himself like a man who's comfortable in expensive restaurants and uncomfortable in firefights. Always well-groomed even in terrible conditions. Adjusts his cuffs when he's thinking. Touches his temple where the authentication key lives — an unconscious tell the heroes might eventually notice.

*The three gears:*
1. **Charming Varth** (Adv1–3): The Cool Uncle. Nicknames, jokes, tactical coaching, genuine warmth. This is the Varth who pays up and watches your back. He's fun to be around. The players should like him.
...
**What Varth Is Not:**
- He is NOT a cackling villain. He doesn't enjoy cruelty.
- He is NOT a sociopath. He has real feelings — he just subordinates them to objectives.
- He is NOT redeemable in the traditional sense. He won't have a change of heart. But he might, in the final moment, acknowledge what he cost the people he used. That acknowledgment — not an apology, just recognition — is the closest he gets to humanity.
- He is NOT the Empire. He used the Empire the same way he used the heroes. The Empire is a machine. Varth is the man who decided he should be driving it.
...
### Varga the Hutt
**Full Name:** Varga Besadii Drokko | **Species:** Hutt | **Role:** Crime Lord, Act 1 Antagonist

**What the Players See:** A paranoid, greedy Hutt crime lord who runs operations on Jakku and Takodana. He's connected to the Imperial supply chain (Project Leviathan) but doesn't understand or care about the bigger picture — he just makes money. He's dangerous, vindictive, and surrounded by muscle. His court on Takodana is a cesspit of gladiatorial spectacle, slave trading, and Imperial backroom deals.

**What the GM Knows:** Varga is a member of Clan Besadii — one of the most powerful Hutt kajidics and a canonical rival to Jabba's Desilijic clan. Besadii has historically competed for control of the spice trade, slave markets, and Imperial logistics contracts. Varga is a mid-level player within Besadii's hierarchy: ambitious enough to run his own operation, but not powerful enough to challenge the clan elders. He launders credits, moves materials, and provides Hutt infrastructure for Imperial logistics through Project Leviathan. He doesn't know what Leviathan actually is — he only knows it pays well. His fortress on the far shore of Nymeve Lake (Takodana) doubles as a staging ground for Besadii's Outer Rim operations.

Varth used Varga's network to embezzle millions from the Empire. The stolen credits are locked in an encrypted account inside Varga's own financial network. Varga can see the credits are there but can't get past the encryption — Varth memorized the authentication key. Varga wants Varth alive because Varth is the *key* to unlocking a fortune sitting in Varga's own vault.
...
- Adv3: Cornered on Cloud City. Heroes board the Chariot. Varga is killed during the boarding — his arc as Act 1 antagonist ends here.

---

### Inquisitor Valin Draco
**Species:** Human | **Role:** Imperial Nemesis, Recurring Threat
...
### Oga Garra
**Species:** Blutopian | **Role:** Crime Boss, Act 3 Ally
...
**What the GM Knows:** Switch is a genuinely useful recurring asset. His network (including TC-663 inside Varga's fortress) spans the criminal underworld. He's not aligned with anyone — he sells information to whoever pays. His deal with the heroes is transactional but honest: he reduces his diagnostic fee in exchange for the heroes becoming information assets. As they travel, they pass along intel — names, locations, movements, deals. If the intel is validated and leads to actionable resources, Switch compensates them. He also serves as a black market connection for gear, smuggling contacts, and fencing stolen goods.
...
- Adv1 P2 S8: Covers the heroes' retreat during the climax. His fate is a player-driven decision at the climax (adv1-p2-s8-key-decision) with four outcomes — **survived** (extracted with the crew), **sacrificed** (held the line and died covering the escape), **captured** (taken alive by Draco), or **betrayed** (cut a deal with Draco). Hope/Toll is a tiebreaker lens for ambiguous tables, not the trigger.
...
### Igren Demos
**Species:** Neimoidian | **Role:** Varga's Majordomo (deceased)

**What the Players See:** Varga's majordomo — officious, ambitious, Force-sensitive (untrained). He runs the fortress's daily operations and watches the heroes with suspicion throughout their time in the court.
...
**Problem:** Denia is both a security leak and a prize. The heroes keep stumbling into classified operations.
**Interaction:** Draco appears at key moments as an overwhelming threat. Captures Denia in Adventure 7. Acts as the military arm of the campaign's antagonist force.
...
**Why they matter:** The Empire's old routes to Vel Shara have collapsed. These charts can map a new, stable corridor.
...
**Resolution:** The heroes steal them, inadvertently sparking a local insurrection. Combined with the holocron data, this completes the navigation corridor to Vel Shara.
...
3. **Refinery Rumble (P1 S3) → Trandoshan datapad.** Manifest names the *The Indemnity* — slave ship, weapons-grade gas, low Bespin orbit, ~384 souls aboard (legendary tier adds Klosari port history and 61 children counted separately). Maya's verbatim slave-ship line drops here; Varth's careful deflection is the third red flag for attentive players. *Three leads handed simultaneously:* (a) the Indemnity intel, (b) confirmation of Varga's Imperial paymaster route, (c) Maya's silent decision begins to form.
...
7. **The Final Table (P2 S4) → Arandis's card-arrangement transmits 137.12.** *Tactical asset handed (canonical path):* the slave-circuit boarding code for the *Indemnity*. Switch's Dirty Money fork disrupts the card-arrangement but Fioro is still ID'd by other means.
8. **The Heist (P2 S5 Draver's three-way crossfire) → Fioro captured or tailed.** *Lead handed:* Varga's hideout — Docking Bay 4414.
9. **Maya's silent solo run on the *Indemnity*.** Acts on the manifest from P1 S3 and her dock-crew contacts. The crew may not know she's gone until the orbital climax. *Future detonator:* P3 S5 moral choice.
...
12. **Skirmish Over Bespin (P3 S5) — Imperial Cleanup.** Varga's death = failed op = the Empire rams the *Indemnity* with an automated gas hauler to bury the slave-trade trail. Maya is on the ship. *Moral choice fires:* save Maya or jump.
...
- **Mandrake's Fate (Player-Driven):** During the climax, the crew chooses what to do about Mandrake at adv1-p2-s8-key-decision. Four outcomes are tracked — **survived** (extracted), **sacrificed** (covered the escape and died), **captured** (taken alive by Draco), or **betrayed** (cut a deal with Draco). Each outcome reshapes Act 3 differently. Hope/Toll is a tiebreaker lens for ambiguous tables, not the trigger.
...
- Varth reveals: "The money is locked inside Varga's network. I have the key, but the Hutt moved the account after I was captured. We need to get inside his operation."
...
- Vazus Mandrake (→ available in Act 3 if **survived**; offstage echo if **sacrificed**; in Imperial custody if **captured**; serving Draco if **betrayed**)
...
- Industrial Connection: Alliance with Ugnaught administrators Fyren and Krygg. They reveal Varga is siphoning military-grade Tibanna gas for the Empire.
- Refinery Rumble: Heroes stop a gas theft at Refinery Platform 13. The Trandoshan leader's datapad mentions the *The Indemnity* and Imperial deliveries — foreshadowing.
- The Imperial Mark: Intel points to a Sabacc tournament. Lt. Armen Arandis (Imperial bagman) is paying Varga's proxy (Lady Mirana Fioro) through the game.
- The Buy-In: Varth reports Inquisitor Draco's flagship *Assiduous* has arrived. Death clock starts.
- Tournament: Elimination rounds introduce Silas Draver (independent heist specialist) and Lady Fioro (Varga's Hapan proxy). Arandis deliberately loses to Fioro.
- The Final Table: Arandis transmits code 137.12 via his card arrangement (slave circuit code for the Indemnity). Varth decodes it.
- The Heist: Silas Draver launches his own casino robbery. Three-way crossfire. Arandis dies. Fioro reveals Varga's location: Docking Bay 4414.
- **Maya's argument:** After learning about the Indemnity, Maya pushes Varth to free the slaves. He refuses on operational grounds — then, in the open-channel exchange, names the *Assiduous*'s EW jam capability and the only unjammable path: the bridge override panel hard-line, physically aboard the *Indemnity*. He gives her the answer, not a way back. She understands the firmware path and goes silent. She's already decided to go aboard.
- **The Tournament's Real Job:** ID Lady Fioro as Varga's proxy and pin Varga's location (Docking Bay 4414). Pot outcome doesn't matter — the proxy is identifiable through table-reading regardless of who wins. The wafer/137.12 frequency is the **jammable remote-override lane** for the orbital climax: code (wafer) + control computer (Glorious Chariot) = a remote slave-circuit override broadcast that can free *The Indemnity*'s reactor and engines from orbit. The *Assiduous*'s EW package jams the band on a tightening clock as the Star Destroyer closes range (P3 S5). The only unjammable path is Maya's hard-line override on the *Indemnity*'s bridge panel — she goes physically aboard for exactly this reason. Maya doesn't NEED the wafer to slip aboard (manifest from Refinery 13, dock-crew contacts), and the crew doesn't need it to find Varga (they tail Fioro or capture her in the Draver heist crossfire either way). Switch's Dirty Money fork closes the Operator-Chariot lane entirely — Maya is alone on the override — but the Skirmish still runs. Switch's Dirty Money fork is a flavor side payday (5–7% of Moro's pot), not a campaign-level branch.
- **The Skirmish (P3 S5) Scaffold:** First multi-PC-ship scenario in the campaign. Banshee (Varth pilot) + stolen *Glorious Chariot* (PC-crewed, multi-station) + stolen Z-95s (one PC each per cracked cockpit) versus the TIE wing screening the automated Tibanna gas hauler. Initiative is identical to character combat (Tactics/Wits Join Battle, one slot per PC, one slot per enemy hull — see gamesystem 'starship_combat'). 5-round dramatic clock with GM +1/-1 dial. Two paths to save Maya: the Operator-Chariot remote override (diminishing returns: Resist 3 → 4 → 5, lane closes Round 5) or Maya's 5-progress hard-line bridge override (unjammable, ticks +1/round automatically, PCs can push it). Three outcomes: hauler killed or Maya frees engines → Maya jumps; Round 5 expires → all die (final desperate Pilot Reflex Resist 5 to limp out crippled); abandon → Maya dies. Varth-mask-cracked moment fires if a PC is in real mechanical danger — he uses their actual name for the first time and donates the Banshee's next slot as a free Evade. The starship-combat UI button is intentionally unwired — run as narrative scaffold; statblocks deferred to the GM.
- **The Assault Is the Only Opening:** If the crew lets Varga collect the Imperial payday and walk, he has enough to vanish for years and the campaign loses its only path to the encrypted account. Killing him at Bespin and ripping the courier implant from his corpse is the only viable play. The GM should never let the table passively drift past this — Varth, Mandelbrot, and Maya all push for the strike.
- The Gauntlet: Chase through Cloud City to the hangars.
- Hangar Bay: Battle at Docking Bay 4414. Heroes fight through Varga's mercenaries, Z-95 Headhunters, and board the *Glorious Chariot*. Varga's last stand.
- Grand Theft Starship: Commandeer the Chariot. 30-second countdown before Stormtroopers arrive.
- **Skirmish Over Bespin (Imperial Cleanup):** The assault on Varga is what triggers the orbital crisis. The Empire treats Varga's death as a failed op and moves to bury the evidence — they ram the *The Indemnity* with an automated Tibanna gas hauler to scrub the slave-trade trail. Heroes break atmosphere in the Chariot and see the collision course unfolding. Varth comes on comms: "Set coordinates and jump. The Assiduous is launching TIEs." If heroes mention the slave ship: "It's too hot. Jump. Now." Then Maya's voice cuts in on open comms: "Hey — I could use a little more time here. I've got about three hundred people in chains and a freighter about to turn us into scrap." The heroes choose.
...
- **Payday and Pivot:** The crew jumps to Takodana — Maz Kanata's castle, the agreed fallback. The *Banshee* and the captured *Glorious Chariot* set down on the lake apron together. When they drop out of hyperspace, the *The Indemnity* is already in low orbit — a massive Imperial bulk transport, too large to land, hull scarred and ugly. Maya got here first, shuttling freed slaves down to Maz's. Denia is already planetside, recovering at Maz's since the end of Adventure 2. When the crew lands, Maya walks straight to Varth and punches him in the jaw. He takes it. Varth then takes the courier implant the heroes recovered from Varga's skull, pairs it with his memorized authentication key, and unlocks the encrypted account in front of them. The heroes and Maya get their promised cut — a considerable sum. Then Varth pivots: "That's a portion. The real vault is at Vel Shara — where the Empire is building something they don't want anyone to know about. I need a safe route through the Unknown Regions to get there." He casually looks to Denia: "How *did* the Jedi navigate this part of space?" Denia suggests the Ebon Spire on the forest moon of Endor. Varth nods like he's hearing it for the first time.

**What Changes by the End:**
- Heroes acquire the *Glorious Chariot* (new player ship)
- Encrypted account resolved — heroes get paid
- Varth pivots motivation from "the fortune" to "the bigger score at Vel Shara"
- Maya's relationship tested (saved or lost)
- Denia unknowingly steered toward Endor by Varth
- Varga resolved as Act 1 antagonist
- Project Leviathan files acquired from Varga's datapad
- Act 1 concludes

**Open Threads Carried Forward:**
- Vel Shara and the "bigger score" (→ Adv4-6)
- Ebon Spire / holocrons on Endor (→ Adv4)
- Inquisitor Draco / the Assiduous (→ ongoing)
- Project Leviathan (→ ongoing)
- Maya's status (saved or dead — affects Adv4+)
- Denia as Varth's unwitting instrument (→ Adv4)
- Varth's true agenda (hidden until Adv6)

**Threads Resolved:**
- Varga the Hutt (defeated, Act 1 antagonist concluded)
- The encrypted account / payday (paid out)
- The Indemnity / slave circuit code 137.12
- The Glorious Chariot acquisition

---

### Adventure 4: The Ebon Spire
**Act:** 2 | **Location:** Endor (Forest Moon)
...
- Meeting the Ewoks (Chief Chirpa and Paploo) — diplomacy required to reach the Dead Forest
- The Dead Forest: a petrified zone where the Dark Side is strong
- The Descent into the Spire: Revan's ancient tactical notations line the walls
- The Dark Echoes: psychological gauntlet — heroes face shadow versions of themselves. Success grants [Clarity]; failure grants [Corrupted].
- The Nest: Corrupted Knobby Spiders and their Brood Mother
- The Threshold: reaching the data core, recovering Revan's star charts

**What Changes by the End:**
- Heroes recover Revan's star charts — but they're incomplete
- The charts are ancient; stellar drift has made them unreliable without modern correction data (drift algorithms)
- Varth "discovers" that the drift algorithms exist at an Imperial research station on Malpaz
- The heroes think they need one more piece to reach the payday at Vel Shara

**Open Threads Carried Forward:**
- Drift algorithms on Malpaz (→ Adv5)
- Varth's true agenda (still hidden)
- Vel Shara as destination (→ Adv5-6)
...
### Adventure 5: The Malpaz Insurrection
**Act:** 2 | **Location:** Malpaz (occupied industrial world)

**What the Players Know Going In:** The holocron charts need drift algorithms to be usable. Those algorithms are at an Imperial research station on Malpaz. One more job, one more step to the payday at Vel Shara.

**What the GM Knows:** This is the last piece Varth needs. Once the heroes retrieve the drift algorithms, he has a complete navigation package to present to Tarkin. The insurrection the heroes spark on Malpaz will have devastating consequences in Adventure 10 — the same world becomes the Leviathan's demonstration target.

**Key Plot Beats:**
- Infiltrating an occupied Imperial world — checkpoints, patrols, surveillance
- Stealing the drift algorithms from an Imperial research station
- The heroes' actions inadvertently spark a local rebellion among the oppressed population
- Extraction under fire as the insurrection spreads

**What Changes by the End:**
- Heroes have the drift algorithms — the navigation package is complete
- Malpaz is in open revolt (consequences in Adv10)
- Varth now has everything he needs

**Open Threads Carried Forward:**
- Complete navigation data (→ Adv6)
- Malpaz insurrection (→ Adv10 — Leviathan targets this world)
- Varth's betrayal approaching (→ Adv6)

**Threads Resolved:**
- Drift algorithm retrieval

---

### Adventure 6: The Core of Corruption
**Act:** 2 | **Location:** Eriadu (Tarkin's seat of power)
...
**What Changes by the End:**
- Varth is revealed as the campaign's true antagonist
- The heroes realize they built the road to the superweapon
- The "payday" was always a leash — the real prize was the navigation data
- The campaign shifts from "get paid" to "stop what we helped create"
- Act 2 concludes

**Open Threads Carried Forward:**
- Leviathan under Varth's command (→ Adv7-10)
- Heroes hunted by the Empire (→ Adv7)
- Malpaz as Leviathan's target (→ Adv10)

**Threads Resolved:**
- Varth's true identity and agenda
- The "bigger score at Vel Shara" — it was never real for the heroes
- The navigation data (now in Imperial hands)

---

### Adventure 7: The Crucible
**Act:** 3 | **Location:** Eriadu

**What the Players Know Going In:** Varth has betrayed them. The Empire has the navigation data. The heroes are trapped on an Imperial core world with no allies.
...
- Inquisitor Draco captures Master Denia
- Heroes flee into hyperspace with nothing

**What Changes by the End:**
- Resurgence destroyed — no more support base
- Denia captured — mentor lost
- Heroes are alone, hunted, and have to rebuild from nothing

**Open Threads Carried Forward:**
- Denia's captivity (→ Adv9)
- Building a fleet to stop Leviathan (→ Adv8)
- Leviathan approaching Malpaz (→ Adv10)

**Threads Resolved:**
- The Resurgence as a safe haven

---

### Adventure 8: The Iron Blockade
**Act:** 3 | **Location:** Batuu (Black Spire Outpost)

**What the Players Know Going In:** They need a fleet. The Leviathan is heading to Malpaz for a demonstration strike. The people who rose up because of the heroes' actions in Adventure 5 are the target.

**What the GM Knows:** Oga Garra is their only option for assembling a fighting force. She's transactional — she'll help because Leviathan is bad for business, but she'll collect on the debt.
...
### Adventure 9: The Point of No Return
**Act:** 3 | **Location:** Xala (Wild Space)

**What the Players Know Going In:** Denia is being held at Draco's stronghold. The fleet is assembling. There may be time for one last mission before the final battle.
...
- If skipped: Denia is lost permanently

**What Changes by the End:**
- Denia rescued or permanently lost
- Heroes are committed — no more side missions
- The fleet is ready

**Open Threads Carried Forward:**
- Final assault on Leviathan (→ Adv10)

---

### Adventure 10: Jaws of the Leviathan
**Act:** 3 | **Location:** Malpaz
...
## Varth's Master Plan (GM Only)

This section lays out Varth's complete scheme from start to finish. Every step the heroes take in Acts 1 and 2 serves this agenda — even when it looks like they're pursuing their own interests.

### Phase 1: The Rescue (Adventures 1)
**Varth's goal:** Get rescued from the Vanishing Place.
**How:** Before his capture, Varth arranged for a code cylinder containing transfer order intel to be smuggled out. It was designed to eventually lead someone capable to his prison. Maya intercepted it — a lucky break for Varth, because she's exactly the kind of resourceful operator who would follow through.
**What the heroes think:** "We're rescuing a rich fugitive who'll pay us."
**What's really happening:** Varth is being extracted by expendable contractors who think they're chasing money.
...
**Varth's goal:** Deploy the Leviathan. Demonstrate its power. Cement his position in the Empire.
**What the heroes do:** Try to undo it. They've lost their mentor (Denia captured), their base (Resurgence destroyed), and their illusions. They rebuild from nothing — assembling a pirate fleet through Oga Garra — and lead a desperate assault against the weapon they helped create.
**The target:** Malpaz. The same world whose people rose up because the heroes inspired them in Adventure 5. Varth is going to obliterate it as a demonstration, and it's the heroes' fault twice over.

---

## The Payday Thread

The financial motivation is the campaign's connective tissue through Act 1 and into Act 2. Here's how it evolves:

### Hook: "A Stolen Fortune" (Adventures 1–3)
The heroes are promised a cut of Varth's embezzled millions. Every adventure in Act 1 keeps the money just out of reach:
- Adv1: "Rescue me and I'll make you rich."
- Adv2: "Get inside Varga's network and find where the money is."
- Adv3: "Track Varga to Bespin. The routing data is the last piece."

**Resolution (End of Adv3):** Varth *pays them.* This is crucial — the heroes actually receive a considerable sum. If you string players along for three adventures and never deliver, they stop trusting the narrative. The payday is real.

### Pivot: "The Bigger Score" (Adventures 3–5)
Immediately after paying them, Varth dangles a bigger prize:
- "That was a portion. The real vault is at Vel Shara."
- "I need a safe route through the Unknown Regions."
- "One more job. Then we're all rich beyond counting."

The heroes believe it because Varth just proved he pays up. They're not naive — they're making a rational decision based on a track record of delivery.

### Collapse: "It Was Never Real" (Adventure 6)
The "bigger score at Vel Shara" was a lie. There is no second vault. Vel Shara is where the Leviathan is being built. Varth used the promise of money to keep the heroes retrieving assets he planned to trade for power.

The embezzled fortune was real — and the heroes got their cut. But it was always small compared to what Varth was really after. The money was a leash, not a partnership.

### Transformation: "Something Worth More Than Money" (Adventures 7–10)
With the payday exposed as a manipulation, the heroes' motivation must transform. They're no longer working for money — they're working to undo the damage they caused. The people of Malpaz. The navigation data they retrieved. The weapon they helped activate.

This transformation is the emotional core of Act 3. The heroes started as mercenaries. They end as people who chose to fight for something that doesn't pay.
...
| **Vazus Mandrake** | Adv1 P2 S8 | **PLAYER-DRIVEN FATE.** Separatist commando gone native on Ajan Kloss. Adopted indigenous culture, protects local population from Skarn's occupation. Fought alongside heroes at the Vanishing Place. His fate is decided by the crew at adv1-p2-s8-key-decision with four tracked outcomes: **survived** — extracted with the heroes, available as a Rebel-adjacent contact in Act 3; **sacrificed** — held the line so the Banshee could lift, dies on his own terms (offstage echo only); **captured** — taken alive by Draco, becomes a leverage piece in later adventures; **betrayed** — cut a deal with Draco at the wire, now serves the Inquisitor as a hunter who knows the crew. Hope/Toll is a tiebreaker lens for ambiguous tables, not the trigger. |
...
1. The GM records decisions during play with `campaign_impact` tags (e.g., `maya-fate` set to "Maya died on the Indemnity").
