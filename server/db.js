...
async function seedNpcProfiles() {
  ...
  const timelineEntries = [
    { npc_key: 'draco', adventure_ref: 'Adv 1', scene_ref: 'adv1-p2-s8', event_text: 'A Lambda shuttle descended onto the fortress landing pad. A dark figure emerged — Inquisitor Valin Draco, flanked by Shadow Troopers. He came for Varth. The crew got there first.', revealed: false },
    { npc_key: 'draco', adventure_ref: 'Adv 3', scene_ref: 'adv3-p2-s2', event_text: 'The Star Destroyer Assiduous dropped out of hyperspace over Bespin. Varth identified it as Draco\'s flagship — the "clean-up crew" for Project Leviathan. If the deal goes wrong, he\'ll glass Cloud City to bury the evidence.', revealed: false },
