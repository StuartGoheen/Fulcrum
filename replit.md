...
- `data/threats.json` — NPC Threat Builder data: Fulcrum rules system (Tier 0-5, Arena Scores 1-5, 12 Roles, 4 Classifications, Traits, Tags, prebuilt templates). Power=(Arena-1)+Tier, Defense=max(PHY,REF)-1+Tier, Evasion=REF-1+Tier, Resist=GRT-1+Tier, Vitality=PHY+GRT+Tier. Classifications: Standard (base), Minion (Masterful+=takedown), Elite (+1 Exploit, x1.5 VIT), Boss (x2 VIT, N-1 Exploits)
