...
│   ├── npc-builder.js     # NPC Threat Builder overlay (Tier/Arena/Role/Classification builder, loot attachment, save/recall, loot-to-PC assignment)
...
- `data/threats.json` — NPC Threat Builder data: Fulcrum rules system (Tier 0-5, Arena Scores 1-5, 13 Roles [10 combat + 3 social], 4 Classifications, Traits, Tags with mechanical effects, prebuilt templates). Power=(Arena-1)+Tier, Defense=max(PHY,REF)-1+Tier, Evasion=REF-1+Tier, Resist=GRT-1+Tier, Vitality=PHY+GRT+Tier. Classifications: Standard (base), Minion (Masterful+=takedown), Elite (+1 Exploit, x1.5 VIT), Boss (x2 VIT, N-1 Exploits). Roles: Trooper/Brute/Marksman/Skirmisher/Operative/Commander/Technician/Mystic/Beast/Face/Enforcer/Informant/Diplomat
