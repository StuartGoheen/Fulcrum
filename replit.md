...
- `GET  /api/campaign/scene-intel/:sceneId` — scene intelligence engine: cross-references scene tags against party character profiles to produce per-character insights (destiny resonance, vocation matches, key discipline rankings, gear gap warnings, challenge readiness ratings, background ties)
